...
function Sidebar() {
  ...
  return (
    <aside className="flex w-auto md:h-full md:max-h-full md:min-h-full md:w-auto">
      <div
        className="fixed bottom-0 left-0 z-50 flex h-[50px] w-full gap-6 self-end overflow-auto border-t bg-secondary border-border dark:border-darkHover dark:bg-dark p-3 md:static md:h-full md:w-[50px] md:min-w-[50px] md:flex-col md:border-r md:border-t-0 md:p-2 md:pt-4"
      ...
      <div
        className="absolute p-1 left-0 z-20 h-[calc(100%-50px-65px)] md:h-full w-screen flex-grow flex-col bg-secondary dark:bg-dark md:static md:w-[300px] overflow-y-auto"
